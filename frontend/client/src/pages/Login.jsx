    ...
    <div className="min-h-[85vh] flex items-center justify-center p-4 bg-emerald-50">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden p-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight mb-2">Login to LostFound</h1>
        ...
        <p className="mt-8 text-center text-sm text-gray-600 font-medium">
          ...
          <Link to="/signup" className="text-emerald-600 hover:text-emerald-700 hover:underline transition-colors">
            Create an account
          </Link>
        </p>
      </div>
