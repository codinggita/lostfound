    ...
    <div className="min-h-[85vh] flex items-center justify-center p-4 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700/50 overflow-hidden transition-all duration-300 p-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <button 
            type="submit" 
            className="mt-2 w-full py-3.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-[15px] shadow hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800"
          >
            Sign In
          </button>
        </form>
        ...
        <p className="mt-8 text-center text-sm text-gray-600 dark:text-gray-400 font-medium">
          ...
          <Link to="/signup" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 hover:underline transition-colors">
            Create an account
          </Link>
        </p>
      </div>
