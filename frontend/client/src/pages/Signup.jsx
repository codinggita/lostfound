    ...
    <div className="min-h-[85vh] flex items-center justify-center p-4 bg-emerald-50 dark:bg-gray-900 transition-colors duration-300">
      <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700/50 overflow-hidden transition-all duration-300 p-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div className="group">
            <label htmlFor="name" className="block mb-1.5 font-semibold text-gray-700 dark:text-gray-300 text-sm">
              Full Name
            </label>
            <input
              type="text"
              ...
              className={`w-full p-3.5 rounded-xl border ${
                errors.name ? 'border-red-500 ring-1 ring-red-500/20' : 'border-gray-300 dark:border-gray-600 hover:border-emerald-400'
          ...
          <button
            type="submit"
            className="mt-3 w-full py-3.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-[15px] shadow hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-emerald-300 dark:focus:ring-emerald-800"
          >
            Create Account
          </button>
        </form>
        ...
        <p className="mt-8 text-center text-sm text-gray-600 dark:text-gray-400 font-medium">
          ...
          <Link to="/login" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 hover:underline transition-colors">
            Sign in
          </Link>
        </p>
      </div>
